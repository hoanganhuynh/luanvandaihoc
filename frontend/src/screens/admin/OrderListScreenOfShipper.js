...
const headCells = [
   ...
   { id: 'name', numeric: true, disablePadding: false, label: 'Người giao hàng' },
   // { id: 'date', numeric: true, disablePadding: false, label: 'NGÀY ĐẶT' },
   { id: 'total', numeric: true, disablePadding: false, label: 'TỔNG TIỀN' },
   { id: 'numberPlate', numeric: true, disablePadding: false, label: 'Biển số xe' },
   { id: 'numberPhoneShipper', numeric: true, disablePadding: false, label: 'Số điện thoại' },
...
function OrderListScreenOfShipper({ history, match }) {
   ...
   // const shipper = users && users.filter(user => user.role)
                                       ...
                                       .map((user,order, index) => {
                                          ...
                                          return (
                                             <TableRow
                                                hover
                                                onClick={(event) =>
                                                   handleClick(event, order._id,user._id)
                                                }
                                                role='checkbox'
                                             ...
                                             return (
                                                ...
                                                >
                                                   ...
                                                   >
                                                      ...
                                                      {order.shipper &&
                                                         order.shipper.numberPhoneShipper}
                                                   </TableCell>
                                                   {/* <TableCell
                                                      align='center'
                                                      className='table_th'
...
export default OrderListScreenOfShipper
